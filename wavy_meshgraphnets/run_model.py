...
from wavy_meshgraphnets import cfd_eval
from wavy_meshgraphnets import cfd_model
from wavy_meshgraphnets import cloth_eval
from wavy_meshgraphnets import cloth_model
from wavy_meshgraphnets import core_model
from wavy_meshgraphnets import dataset
...
flags.DEFINE_integer('latent_size', 128, 'Latent size of the model')
flags.DEFINE_integer('message_passing_steps', 15, 'Number of message passing steps')
flags.DEFINE_enum('update_rule', 'mix', ['mix', 'wave'],
                  'Use the Mix or Wave update rule.')
